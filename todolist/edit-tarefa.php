...
if (!isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM lista_tarefas WHERE id = '{$tarefaId}'";
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Editar Tarefa <i class="bi bi-pencil-square"></i></h4>
                        </div>
                        <div class="card-body">
                            <?php
                            if ($usuario) :
                            ...
                            <form action="acoes.php" method="post">
                                <input type="hidden" name="tarefa_id" value="<?=$usuario['id']?>">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="txtDescricao" id="txtDescricao" value="<?=$usuario['descricao']?>" class="form-control">
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <label for="txtDataLimite">Data Limite</label>
                                        <input type="date" name="txtDataLimite" id="txtDataLimite" value="<?=$usuario['data_limite']?>" class="form-control">
                                    </div>
                                    <div class="col">
                                ...
                                <div class="mb-4">
                                    <button type="submit" name="edit_tarefa" class="btn btn-primary float-end mt-3 "> <i class="bi bi-floppy-fill"></i></button>
                                </div>
                                </form>
                                <?php
                                else:
